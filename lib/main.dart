...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    audioPlayer.play(UrlSource("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"));
    ...
    _streamSubscriptions.add(
      accelerometerEventStream(samplingPeriod: sensorInterval).listen(
          ...
          final now = DateTime.now();
          setState(() {
            // double speed = sqrt(event.x * event.x + event.y * event.y + event.z * event.z) / 10;
            // audioPlayer.setPlaybackRate(speed.clamp(0.5, 2.0));
